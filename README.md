...
### 2. `/super` - 슈퍼 프롬프트 생성 ⚡ 토큰 최적화

간단한 요청을 구체적인 요구사항으로 확장합니다. **자동 간결 모드로 1회 사용 시 토큰 15% 절약!**
...
/super -o 복잡한 요청  # opus
/super --compact 요청  # 명시적 간결 모드
```

**토큰 최적화 (자동 감지)**:
- **<15단어**: Ultra-Compact (500 토큰) - 핵심만
- **15-29단어**: Compact (800 토큰) - 요약 버전
- **30+단어**: Full (2,300 토큰) - 전체 분석
...
### 6. `/planner` - 프로젝트 기획서 작성 ⭐ NEW ⚡ 토큰 최적화
